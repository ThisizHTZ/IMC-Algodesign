...
class Trader:
        ...
        if delta_hedge_qty > 0:
            ...
            if buy_qty > 0:
                ...
                result[product_strings[Product.VOLCANIC_ROCK]].append(
                    Order(product_strings[Product.VOLCANIC_ROCK], new_spot, buy_qty))
            ...
            if sell_qty > 0:
                ...
                result[product_strings[Product.VOLCANIC_ROCK]].append(
                    Order(product_strings[Product.VOLCANIC_ROCK], new_spot, -sell_qty))
    ...
    def run(self, state: TradingState):
        ...
        if self.prev_spot:
            self.gamma_scalp(result, self.prev_spot, spot, positions[option], positions[Product.VOLCANIC_ROCK], delta,
                             gamma)
