...
class Trader:
    ...
    def VolcanicRockCoupon_strat(self,
        ...
        if Product.VOLCANIC_ROCK not in order_depths.keys() or len(
                order_depths[Product.VOLCANIC_ROCK].buy_orders) == 0 or len(
                order_depths[Product.VOLCANIC_ROCK].sell_orders) == 0:
            return option_orders

        if prod not in order_depths.keys() or len(order_depths[prod].buy_orders) == 0 or len(
                order_depths[prod].sell_orders) == 0:
            return option_orders
    ...
    def run(self, state: TradingState):
        ...
        if Product.VOLCANIC_ROCK_VOUCHER_10000 in self.params and Product.VOLCANIC_ROCK_VOUCHER_10000 in state.order_depths.keys() and Product.VOLCANIC_ROCK in state.order_depths.keys():
            ...
            option_orders = self.VolcanicRockCoupon_strat(state.order_depths, Product.VOLCANIC_ROCK_VOUCHER_10000,
                                                          VOLCANIC_ROCK_VOUCHER_10000_position)
            ...
            hedge_orders = self.hedge_option_orders(Product.VOLCANIC_ROCK, state.order_depths, option_orders,
                                                    VOLCANIC_ROCK_position, VOLCANIC_ROCK_VOUCHER_10000_position,
                                                    delta1)
